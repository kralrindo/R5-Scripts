...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    SwitchSurvivalSlotToWeaponInspect
    {
        ...
        navDown					SwchAdaptiveTriggers [$PS5 && !$NX && !$NX_UI_PC]
        navDown					SwchTriggerDeadzone [!$PS5 && !$NX && !$NX_UI_PC]
    ...
    SwchTriggerDeadzone [!$NX && !$NX_UI_PC]
    {
        ...
        className               "SettingScrollSizer"
        style					DialogListButton
        pin_to_sibling			SwitchSurvivalSlotToWeaponInspect [!$PS5]
        pin_to_sibling			SwchAdaptiveTriggers [$PS5]
        pin_corner_to_sibling	TOP_LEFT
        pin_to_sibling_corner	BOTTOM_LEFT
        navUp					SwitchSurvivalSlotToWeaponInspect [!$PS5]
        navUp					SwchAdaptiveTriggers [$PS5]
    ...
    // A customized version of trigger deadzones that is used when Adaptive Triggers are enabled.
    SwchTriggerDeadzoneADT [$PS5]
    {
        ControlName				RuiButton
        InheritProperties		SwitchButton
        className               "SettingScrollSizer"
    ...
    BtnControllerOpenAdvancedMenu
    {
        ...
        pin_to_sibling			SwchVibration_PS5 [$PS5]
        pin_corner_to_sibling	TOP_LEFT
        pin_to_sibling_corner	BOTTOM_LEFT
        navUp					SwchVibration [!$PS5]
        navUp					SwchVibration_PS5 [$PS5]
