resource/ui/menus/panels/laser_sight_options_color.res
{
	Sizer
    {
        ControlName				Label
	...
	PaletteFrame
	{
		...
		visible					1
		paintbackground			1
        rui                     "ui/laser_sight_palette_bg.rpak"
    ...
    BtnPaletteColor0
    {
        ...
        rui                     "ui/laser_sight_palette.rpak"
    }
    BtnPaletteColor1
    {
        ControlName				RuiButton
    ...
    BtnReticleColor
    {
        ...
        pin_to_sibling			BtnDefaultColor
        pin_corner_to_sibling	TOP
        pin_to_sibling_corner	BOTTOM

        navUp                   BtnDefaultColor
        navDown                 H_Slider
        cursorPriority			1
    ...
    CurrentPreviousColor
    {
        ...
        paintbackground			1
        proportionalToParent    1
        rui                     "ui/laser_sight_current_previous_color.rpak"
	...
	PreviousColorButton
    {
        ...
        visible					0
        enabled					1
        rui						"ui/laser_sight_previous_color_button.rpak"
        labelText				""
	...
	ColorB
    {
        ...
        tall					27
        visible				    1
        rui                     "ui/laser_sight_color_textframe.rpak"
