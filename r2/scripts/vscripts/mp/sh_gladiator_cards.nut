...
#endif
		tierEntryring statRef = GetGlobalSettingsString( ItemFlavor_GetAsset( flavor ), "statRef" )
...
 _ItemFlavorLoadoutSlotDidChange_AnyPlayer( entry, OnGladiatorCardSlotChanged )
