...
void function MythicInspect_UpdateButtonForEquips( ItemFlavor itemFlav, StoreInspectUIData uiData )
{
	...
	bool hideEquipButton = ItemFlavor_GetType( itemFlav ) == eItemType.character_execution && CharacterExecution_IsNotEquippable( itemFlav )
	Hud_SetVisible( uiData.purchaseButton, !hideEquipButton )
}
